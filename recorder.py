...
saveentry = tk.Entry(save_col, insertbackground="white",
                     bg="#1c1c1c", fg="#eaeaea",
                     relief="flat", width=18)
saveentry.pack()
...
loadentry = tk.Entry(load_col, insertbackground="white",
                    bg="#1c1c1c", fg="#eaeaea",
                    relief="flat", width=18)
loadentry.pack()
...
tk.Button(button_row, text="Save",
          command=saver,
          width=15, bg="#1c1c1c",
          fg="#eaeaea", relief="flat").pack(side="left", padx=10)

tk.Button(button_row, text="Load",
          command=loader,
          width=15, bg="#1c1c1c",
          fg="#eaeaea", relief="flat").pack(side="left", padx=10)

tk.Button(button_row, text="Set Shortcut",
          command=set_shortcut,
          width=15, bg="#1c1c1c",
          fg="#eaeaea", relief="flat").pack(side="left", padx=10)
